...
namespace SchoolDatabase
{
    ...
    /// </summary>
    public sealed partial class StudentChangePasswordPage : Page
    {
        ...
        public StudentChangePasswordPage()
        {
        ...
        private async void ChangePasswordButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                studentInUse.ChangePassword(OldPasswordTextBox.Text, NewPasswordTextBox.Text);
            }
